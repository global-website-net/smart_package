...
export default function RightSideBanner() {
  ...
  return (
    <div className="hidden md:flex flex-col items-center fixed top-0 right-0 h-full w-[120px] z-50 bg-no-repeat bg-cover" style={{ backgroundImage: "url('/images/green_seperator_menu_right_side.png')" }}>
      <div className="flex flex-col items-center mt-8 gap-4 w-full">
        <Link href="/" className={`py-2 px-4 w-full text-center rounded-md ${pathname === '/' ? 'bg-black text-white' : 'text-white hover:bg-green-900/40'}`}>الرئيسية</Link>
