      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-row items-end justify-between mb-8 gap-2 sm:gap-4">
          ...
          <div className="flex flex-col items-center justify-end flex-1 min-w-[85px]">
            ...
            <div className="text-black text-[11px] sm:text-lg font-bold mt-1 text-center whitespace-nowrap">{getOrderStatusText(order.status)}</div>
          </div>
          ...
          <div className="flex flex-col items-center justify-end flex-1 min-w-[85px]">
            ...
            <div className="text-black text-[11px] sm:text-lg font-bold mt-1 text-center whitespace-nowrap">{order.totalAmount.toFixed(2)}₪</div>
          </div>
          {/* Left: Market Icon above Shop Name */}
          <div className="flex flex-col items-center justify-end flex-1 min-w-[85px]">
            <img src="/images/market_icon.png" alt="Market Icon" className="w-10 sm:w-16 h-10 sm:h-16 mb-1.5 sm:mb-2" />
            <div className="text-black text-[11px] sm:text-lg font-bold mt-1 text-center whitespace-nowrap">{order.purchaseSite}</div>
          </div>
        </div>
        {/* Pay button row */}
