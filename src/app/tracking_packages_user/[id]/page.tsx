      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-row w-full items-end justify-between mb-8 gap-4">
          ...
          <div className="flex flex-col items-center justify-end flex-1 min-w-0">
            ...
            <div className="text-black text-[16px] font-bold text-center whitespace-nowrap">{getStatusText(pkg.status)}</div>
          </div>
          {/* Middle: Receipt Icon + Customs Payment */}
          <div className="flex flex-col items-center justify-end flex-1 min-w-0">
            <img src="/images/receipt_icon.png" alt="Receipt Icon" className="w-16 h-16 mb-3" />
            <div className="text-black text-[16px] font-bold text-center whitespace-nowrap">{(pkg.customs_payment ?? 0).toFixed(2)}₪ جمرك</div>
          </div>
          {/* Left: Price Tag Hexagon Icon */}
          <div className="flex flex-col items-center justify-end flex-1 min-w-0">
            <img src="/images/price_tag_hexagon.png" alt="Price Tag Hexagon" className="w-16 h-16 mb-3" />
            <div className="text-black text-[16px] font-bold text-center whitespace-nowrap">{(pkg.customs ?? 0).toFixed(2)}₪</div>
          </div>
        </div>
        {/* Green Divider */}
        <div className="w-full h-0.5 bg-green-500 mb-8" />
