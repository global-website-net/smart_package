      ...
      <main className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="flex flex-row items-end justify-between mb-8 gap-3 sm:gap-4">
          ...
          <div className="flex flex-col items-center justify-end flex-1 min-w-[105px]">
            ...
            <div className="text-black text-[14px] sm:text-lg font-bold mt-1 text-center whitespace-nowrap">{getStatusText(pkg.status)}</div>
          </div>
          {/* Middle: Receipt Icon + Customs Payment */}
          <div className="flex flex-col items-center justify-end flex-1 min-w-[105px]">
            <img src="/images/receipt_icon.png" alt="Receipt Icon" className="w-14 sm:w-16 h-14 sm:h-16 mb-2.5 sm:mb-2" />
            <div className="text-black text-[14px] sm:text-lg font-bold mt-1 text-center whitespace-nowrap">{(pkg.customs_payment ?? 0).toFixed(2)}₪ جمرك</div>
          </div>
          ...
          <div className="flex flex-col items-center justify-end flex-1 min-w-[105px]">
            ...
            <div className="text-black text-[14px] sm:text-lg font-bold mt-1 text-center whitespace-nowrap">{(pkg.customs ?? 0).toFixed(2)}₪</div>
          </div>
        </div>
        {/* Green Divider */}
        <div className="w-full h-0.5 bg-green-500 mb-8" />
