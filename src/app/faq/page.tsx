  ...
  const faqs = [
    {
      ...
      answer: 'يمكنك تتبع شحنتك بسهولة من خلال إدخال رقم التتبع في الصفحة الرئيسية. كما يمكنك الوصول إلى جميع شحناتك وتفاصيلها من خلال حسابك الشخصي.'
    },
    {
      question: 'ما هي طرق الدفع المتاحة؟',
      answer: 'نقدم مجموعة متنوعة من طرق الدفع بما في ذلك البطاقات الائتمانية، المحفظة الإلكترونية، والتحويل البنكي. جميع المعاملات تتم بشكل آمن ومشفر.'
    },
    {
    ...
    },
    {
      ...
      answer: 'يمكنك التواصل معنا عبر نموذج الاتصال في موقعنا، أو عبر البريد الإلكتروني على info@packagesmart.com، أو عبر الهاتف على الرقم +966 12 345 6789. فريق الدعم متاح على مدار الساعة.'
    },
    {
      question: 'هل تقدمون خدمة الشحن الدولي؟',
      answer: 'نعم، نقدم خدمة الشحن الدولي إلى أكثر من 150 دولة حول العالم. يمكنك الاطلاع على قائمة الدول وأسعار الشحن في صفحة خدماتنا.'
    },
    {
      question: 'ما هي مدة صلاحية الباقة؟',
      answer: 'تختلف مدة صلاحية الباقة حسب نوع الاشتراك الذي تختاره. الباقة الأساسية صالحة لمدة شهر، بينما الباقة المتقدمة صالحة لمدة 3 أشهر، والباقة الاحترافية صالحة لمدة سنة.'
    },
    {
