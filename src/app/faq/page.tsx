      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-lg font-bold mb-4">عن الشركة</h4>
              <p className="text-gray-400">نقدم حلولاً ذكية لتتبع وإدارة شحناتك بسهولة وكفاءة.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-400">البريد الإلكتروني: info@smartpackage.com</li>
                <li className="text-gray-400">الهاتف: +972 123 456 789</li>
              </ul>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">&copy; {new Date().getFullYear()} SMART PACKAGE. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
