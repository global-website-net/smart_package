            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              >
                <div className="w-24 h-24 mx-auto mb-4 relative flex items-center justify-center">
                  <img src="/amazon-logo.png" alt="Amazon Logo" width={96} height={40} style={{objectFit: 'contain'}} />
                </div>
              ...
              >
                <div className="w-24 h-24 mx-auto mb-4 relative flex items-center justify-center">
                  <img src="/ebay-logo.png" alt="eBay Logo" width={96} height={40} style={{objectFit: 'contain'}} />
                </div>
              ...
              >
                <div className="w-24 h-24 mx-auto mb-4 relative flex items-center justify-center">
                  <img src="/aliexpress-logo.png" alt="AliExpress Logo" width={96} height={40} style={{objectFit: 'contain'}} />
                </div>
              ...
              >
                <div className="w-24 h-24 mx-auto mb-4 relative flex items-center justify-center">
                  <img src="/sephora-logo.png" alt="Sephora Logo" width={96} height={40} style={{objectFit: 'contain'}} />
                </div>
